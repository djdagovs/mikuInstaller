...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/hajimxmiku/mikuInstaller/master/nginx.conf"
mkdir -p /home/Private/public_html
echo "<pre>Setup by hajimxmiku12</pre>" > /home/Private/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/Private/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/hajimxmiku/mikuInstaller/master/vps.conf"
sed -i 's/listen = \/var\/run\/php5-fpm.sock/listen = 127.0.0.1:9000/g' /etc/php5/fpm/pool.d/www.conf
service php5-fpm restart
service nginx restart

# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/hajimxmiku/mikuInstaller/master/openvpn.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/hajimxmiku/mikuInstaller/master/1194-debian.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/hajimxmiku/mikuInstaller/master/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/hajimxmiku/mikuInstaller/master/1194-client.conf"
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/hajimxmiku/mikuInstaller/master/squid.conf"
...
cd
wget "https://github.com/hajimxmiku/mikucript/blob/master/menu"
...
# info
clear
echo "Installer by: Hajimxmiku12"
